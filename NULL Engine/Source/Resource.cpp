...
const char* Resource::GetTypeAsString() const
{
	...
	case RESOURCE_TYPE::SCRIPT:		{ return "SCRIPT"; }	break;
	}
...
std::string Resource::GetAssetsName() const
{
	uint dotPos = assets_file.find_last_of(".");
	return assets_file.substr(0, dotPos);
}