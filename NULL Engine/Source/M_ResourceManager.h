...
public:																												// --- ASSETS MONITORING METHODS ---
	...
	void			RefreshDirectory				(const char* directory, std::vector<std::string>& files_to_import, std::vector<std::string>& files_to_update, std::vector<std::string>& files_to_delete);
	
	void			FindFilesToImport				(const std::vector<std::string>& asset_files, const std::vector<std::string>& meta_files, std::map<std::string, std::string>& file_pairs, std::vector<std::string>& files_to_import);
	void			FindFilesToUpdate				(const std::map<std::string, std::string>& file_pairs, std::vector<std::string>& files_to_update);
	void			FindFilesToDelete				(const std::vector<std::string>& meta_files, const std::map<std::string, std::string>& file_pairs, std::vector<std::string>& files_to_delete);
...
public:																												// --- RESOURCE METHODS ---
	...
	void			GetResourcesOfType				(const RESOURCE_TYPE type, std::vector<Resource*>& resourcesOfType) const;				// 
