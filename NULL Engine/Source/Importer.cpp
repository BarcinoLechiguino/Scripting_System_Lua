...
bool Importer::ImportScript(const char* buffer, R_Script* r_script)
{
	bool success = Importer::Scripts::Import(buffer, r_script);
	if (success)
	{
		//App->scripting_system->scripts.push_back(r_script->GetAssetsFile());
	}
