...
bool M_Input::WindowSizeWasManipulated(Uint8 window_event) const
{
	return (window_event == SDL_WINDOWEVENT_RESIZED
			/*|| window_event == SDL_WINDOWEVENT_SIZE_CHANGED
			|| window_event == SDL_WINDOWEVENT_RESTORED
			|| window_event == SDL_WINDOWEVENT_MAXIMIZED
			|| window_event == SDL_WINDOWEVENT_MINIMIZED*/);
}